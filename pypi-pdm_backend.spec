...
Source0  : https://files.pythonhosted.org/packages/75/2b/0be2d0f2eba3a4acb755fd2b0e442ef67770b2ef6c75fd646d49f20968fa/pdm_backend-2.3.3.tar.gz
...
%prep
%setup -q -n pdm_backend-2.3.3
cd %{_builddir}/pdm_backend-2.3.3
pushd ..
cp -a pdm_backend-2.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721145177
