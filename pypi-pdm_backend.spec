...
Version  : 2.4.4
Release  : 24
URL      : https://files.pythonhosted.org/packages/8d/fc/8efb0e9060167081bcbcddeb5d9e95cee6c762391c42b0c970373a7082ff/pdm_backend-2.4.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/8d/fc/8efb0e9060167081bcbcddeb5d9e95cee6c762391c42b0c970373a7082ff/pdm_backend-2.4.4.tar.gz
...
%prep
%setup -q -n pdm_backend-2.4.4
cd %{_builddir}/pdm_backend-2.4.4
pushd ..
cp -a pdm_backend-2.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744038495
