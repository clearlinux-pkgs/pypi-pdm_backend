...
Version  : 2.3.1
Release  : 15
URL      : https://files.pythonhosted.org/packages/70/f4/eaa4da6e3eaa32d902177e0b81563bb5526b2c387aa312d0dfbecf3c7109/pdm_backend-2.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/70/f4/eaa4da6e3eaa32d902177e0b81563bb5526b2c387aa312d0dfbecf3c7109/pdm_backend-2.3.1.tar.gz
...
%prep
%setup -q -n pdm_backend-2.3.1
cd %{_builddir}/pdm_backend-2.3.1
pushd ..
cp -a pdm_backend-2.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718822360
