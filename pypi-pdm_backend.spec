...
Source0  : https://files.pythonhosted.org/packages/df/a4/12ca230765c9415dbbda44f541696786ebf7e2d64f00e341251da6e83642/pdm_backend-2.1.3.tar.gz
...
%prep
%setup -q -n pdm_backend-2.1.3
cd %{_builddir}/pdm_backend-2.1.3
pushd ..
cp -a pdm_backend-2.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689176936
